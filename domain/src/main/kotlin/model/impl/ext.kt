...
public fun episode(block: EpisodeImpl.DslBuilder.() -> Unit): Episode =
    EpisodeImpl.DslBuilder().apply(block).build()
...
public fun episodeFilter(block: FilterQueryImpl.EpisodeFilterImpl.DslBuilder.() -> Unit): FilterQuery.Filter.EpisodeFilter =
    FilterQueryImpl.EpisodeFilterImpl.DslBuilder().apply(block).build()